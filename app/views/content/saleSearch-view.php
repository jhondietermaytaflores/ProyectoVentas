...
<div class="container pb-6 pt-6">
    ...
    <div class="columns">
        <div class="column">
            <form class="has-text-centered mt-6 mb-6 FormularioAjax has-text-white" action="<?php echo APP_URL; ?>app/ajax/buscadorAjax.php" method="POST" autocomplete="off" >
                <input type="hidden" name="modulo_buscador" value="eliminar">
                <input type="hidden" name="modulo_url" value="<?php echo $url[0]; ?>">
                <p><i class="fas fa-search fa-fw "></i> &nbsp; Estas buscando por código <strong class="has-text-black">“<?php echo $_SESSION[$url[0]]; ?>”</strong></p>
                <br>
