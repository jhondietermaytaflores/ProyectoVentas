<div class="container is-fluid mb-6">
    <h1 class="title has-text-white">Categorías</h1>
        ...
        <div class="column">
            <form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/buscadorAjax.php" method="POST" autocomplete="off" >
                ...
                <div class="field is-grouped">
                    ...
                    <p class="control">
                        <button class="button is-info is-outlined" type="submit" >Buscar</button>
                    </p>
                </div>
            </form>
        </div>
    ...
    <div class="columns">
        <div class="column">
            <form class="has-text-centered mt-6 mb-6 FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/buscadorAjax.php" method="POST" autocomplete="off" >
                ...
                <input type="hidden" name="modulo_url" value="<?php echo $url[0]; ?>">
                <p class="has-text-white"><i class="fas fa-search fa-fw"></i> &nbsp; Estas buscando <strong class="has-text-black">“<?php echo $_SESSION[$url[0]]; ?>”</strong></p>
                <br>
