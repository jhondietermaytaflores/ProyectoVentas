...
<div class="container pb-6 pt-6">
	...
	<h2 class="title has-text-centered has-text-white"><?php echo $datos['cliente_nombre']." ".$datos['cliente_apellido']." (".$datos['cliente_tipo_documento'].": ".$datos['cliente_numero_documento'].")"; ?></h2>
	...
	<form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/clienteAjax.php" method="POST" autocomplete="off" >
		...
		<p class="has-text-centered">
			<button type="submit" class="button is-success is-rounded is-outlined is-large"><i class="fas fa-sync-alt"></i> &nbsp; Actualizar</button>
		</p>
