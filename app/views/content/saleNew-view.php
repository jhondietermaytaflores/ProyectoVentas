<div class="container is-fluid mb-6">
	<h1 class="title has-text-white">Ventas</h1>
...
<div class="container pb-6 pt-6">
    ...
    <div class="columns">
        ...
        <div class="column pb-6">
            ...
            <p class="has-text-centered pt-6 pb-6" style="color: #bdc3ff;">
                <small>Para agregar productos debe de digitar el código de barras en el campo "Código de producto" y luego presionar &nbsp; <strong class="is-uppercase has-text-black textoBorder" ><i class="far fa-check-circle"></i> &nbsp; Agregar producto</strong>. También puede agregar el producto mediante la opción &nbsp; <strong class="is-uppercase has-text-black textoBorder"><i class="fas fa-search"></i> &nbsp; Buscar producto</strong>. Ademas puede escribir el código de barras y presionar la tecla <strong class="is-uppercase has-text-black textoBorder">enter</strong></small>
            </p>
            <form class="pt-6 pb-6" id="sale-barcode-form" autocomplete="off">
                <div class="columns">
                    <div class="column is-one-quarter">
                        <button type="button" class="button is-success is-outlined js-modal-trigger" data-target="modal-js-product" ><i class="fas fa-search"></i> &nbsp; Buscar producto</button>
                    </div>
                    <div class="column">
            ...
            ?>
            <div class="notification is-info is-dark mb-2 mt-2">
                ...
                <div class="container">
                    <div class="columns">
                        <div class="column has-text-centered">
                            <button type="button" class="button is-primary is-inverted" onclick="print_ticket('<?php echo APP_URL."app/pdf/ticket.php?code=".$_SESSION['venta_codigo_factura']; ?>')" >
                                <i class="fas fa-receipt fa-2x"></i> &nbsp;
                                Imprimir ticket de venta
                            </buttona>
                        </div>
                        <div class="column has-text-centered">
                            <button type="button" class="button is-primary is-inverted " onclick="print_invoice('<?php echo APP_URL."app/pdf/invoice.php?code=".$_SESSION['venta_codigo_factura']; ?>')" >
        ...
        <div class="column is-one-quarter">
            <h2 class="title has-text-centered has-text-white">Datos de la venta</h2>
            <hr>
            ...
            <?php } ?>
                ...
                <div class="control mb-5 has-text-white">
                    <label>Fecha</label>
                    <input class="input" type="date" value="<?php echo date("Y-m-d"); ?>" readonly >
                </div>

                <label class="has-text-white">Caja de ventas <?php echo CAMPO_OBLIGATORIO; ?></label><br>
                ...
                <label class="has-text-white">Cliente</label>
                <?php
                ...
                <h4 class="subtitle is-5 has-text-centered has-text-weight-bold mb-5 has-text-white"><small>TOTAL A PAGAR: <?php echo MONEDA_SIMBOLO.number_format($_SESSION['venta_total'],MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR)." ".MONEDA_NOMBRE; ?></small></h4>
    ...
    <?php }else{ ?>
        <article class="message is-warning">
            ...
            <div class="message-body has-text-centered"><i class="fas fa-exclamation-triangle fa-2x"></i><br>No hemos podio seleccionar algunos datos sobre la empresa, por favor <a href="<?php echo APP_URL; ?>companyNew/" >verifique aqui los datos de la empresa</div>
        </article>
    <?php } ?>
</div>
...
<div class="modal" id="modal-js-product">
    ...
    <div class="modal-card" >
        <header class="modal-card-head" style="background: #48c78e;">
          <p class="modal-card-title is-uppercase has-text-black"><i class="fas fa-search"></i> &nbsp; Buscar producto</p>
          <button class="delete" aria-label="close"></button>
        </header>
        <section class="modal-card-body" style="background: #060609;">
            <div class="field mt-6 mb-6">
                <label class="label has-text-white">Nombre, marca, modelo</label>
                <div class="control">
            ...
            <p class="has-text-centered">
                <button type="button" class="button is-success is-outlined" onclick="buscar_codigo()" ><i class="fas fa-search"></i> &nbsp; Buscar</button>
            </p>
        </section>
    </div>
</div>
...
<div class="modal" id="modal-js-client">
    ...
    <div class="modal-card">
        <header class="modal-card-head" style="background: #48c78e;">
          <p class="modal-card-title is-uppercase has-text-black"><i class="fas fa-search"></i> &nbsp; Buscar y agregar cliente</p>
          <button class="delete" aria-label="close"></button>
        </header>
        <section class="modal-card-body" style="background: #060609;">
            <div class="field mt-6 mb-6">
                <label class="label has-text-white">Documento, Nombre, Apellido, Teléfono</label>
                <div class="control">
            ...
            <p class="has-text-centered">
                <button type="button" class="button is-success is-outlined" onclick="buscar_cliente()" ><i class="fas fa-search"></i> &nbsp; Buscar</button>
            </p>
        </section>
    </div>
</div>
