...
<div class="container pb-6 pt-6">
	...
	<div class="columns">
		<div class="column is-two-fifths ">
			<h4 class="subtitle is-4 has-text-centered pb-6 has-text-white">Foto actual del producto</h4>
			...
			<form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/productoAjax.php" method="POST" autocomplete="off" >
				...
				<p class="has-text-centered">
					<button type="submit" class="button is-danger is-rounded is-outlined"><i class="far fa-trash-alt"></i> &nbsp; Eliminar foto</button>
				</p>
			</form>
			<?php }else{ ?>
			<figure class="image mb-6">
		...
		<div class="column has-text-white">
			<h4 class="subtitle is-4 has-text-centered pb-6 has-text-white">Actualizar foto de producto</h4>
			<form class="mb-6 has-text-centered FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/productoAjax.php" method="POST" enctype="multipart/form-data" autocomplete="off" >
				...
				<p class="has-text-centered">
					<button type="submit" class="button is-success is-rounded is-outlined"><i class="fas fa-sync-alt"></i> &nbsp; Actualizar foto</button>
				</p>
			</form>
		</div>
	</div>
