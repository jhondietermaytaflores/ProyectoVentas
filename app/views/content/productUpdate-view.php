<div class="container is-fluid mb-6">
	<h1 class="title has-text-white">Productos</h1>
	<h2 class="subtitle"><i class="fas fa-sync-alt"></i> &nbsp; Actualizar producto</h2>
</div>

<div class="container pb-6 pt-6 has-text-white">
	<?php
	...
	<div class="columns is-flex is-justify-content-center">
    	<figure class="full-width mb-3 " style="max-width: 100px; ">
    		<?php
    			if(is_file("./app/views/productos/".$datos['producto_foto'])){
    				echo '<img class="img-responsive image is-128x128" src="'.APP_URL.'app/views/productos/'.$datos['producto_foto'].'">';
    			}else{
	...
	<h2 class="title has-text-centered has-text-white"><?php echo $datos['producto_nombre']." (Stock: ".$datos['producto_stock_total']." ".$datos['producto_tipo_unidad'].")"; ?></h2>
	...
	<form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/productoAjax.php" method="POST" autocomplete="off" >
		...
		<p class="has-text-centered">
			<button type="submit" class="button is-success is-rounded is-outlined"><i class="fas fa-sync-alt"></i> &nbsp; Actualizar</button>
		</p>
		<p class="has-text-centered pt-6 has-text-black">
