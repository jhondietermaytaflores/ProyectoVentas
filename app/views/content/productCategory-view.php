...
<div class="container pb-6 pt-6">
    ...
    <div class="columns">
        ...
        <div class="column is-one-third ">
            <h2 class="title has-text-centered has-text-white">Categorías</h2>
            <?php
        ...
        <div class="column pb-6">
            <?php
                ...
                if($categoria->rowCount()>0){
                    ...
                    echo '
                        <h2 class="title has-text-centered has-text-white">'.$categoria['categoria_nombre'].'</h2>
                        <p class="has-text-centered pb-6 texto77" >'.$categoria['categoria_ubicacion'].'</p>
                    ';

                    echo $insProducto->listarProductoControlador($url[2],10,$url[0],"",$url[1]);
                }else{
                    echo '
                    <p class="has-text-centered pb-6 has-text-white"><i class="far fa-grin-wink fa-5x"></i></p>
                    <h2 class="has-text-centered title has-text-white" >Seleccione una categoría para empezar</h2>';
                }
            ?>
        </div>
