		                ...
		                <div class="media-content ">
		                    <div class="content">
		                        <p class="has-text-white">
		                            <strong class="has-text-white">'.$contador.' - '.$rows['producto_nombre'].'</strong><br>
		                            <strong class=" textoBorder">CODIGO:</strong> '.$rows['producto_codigo'].', 
		                            <strong class="textoBorder ">PRECIO:</strong> Bs'.$rows['producto_precio_venta'].', 
		                            <strong class="textoBorder">STOCK:</strong> '.$rows['producto_stock_total'].', 
		                            <strong class="textoBorder">CATEGORIA:</strong> '.$rows['categoria_nombre'].'
		                        </p>
		                    </div>
